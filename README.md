...
<tr>
  ...
  <td>
    <p style="display:block;margin:2px 0;text-indent:10px;">5.3.2 Sprint 1</p>
    <p style="display:block;margin:2px 0;text-indent:20px;">5.3.2.1 Sprint Backlog 1</p>
    <p style="display:block;margin:2px 0;text-indent:20px;">5.3.2.2 Development Evidence for Sprint Review</p>
    <p style="display:block;margin:2px 0;text-indent:20px;">5.3.2.3 Testing Suite Evidence for Sprint Review</p>
    <p style="display:block;margin:2px 0;text-indent:20px;">5.3.2.4 Execution Evidence for Sprint Review</p>
    <p style="display:block;margin:2px 0;text-indent:20px;">5.3.2.5 Microservices Documentation Evidence for Sprint Review</p>
    <p style="display:block;margin:2px 0;text-indent:20px;">5.3.2.6 Software Deployment Evidence for Sprint Review</p>
    <p style="display:block;margin:2px 0;text-indent:20px;">5.3.2.7 Team Collaboration Insights during Sprint</p>
    <p style="display:block;margin:2px 0;text-indent:20px;">5.3.2.8 Kanban Board</p>
  </td>
</tr>
  </tbody>
</table>
...
Este entregable comprende la elaboración del Sprint 2.

<img src="./img/insight_tb3.png">
...
- [Capítulo V: Product Implementation, Validation & Deployment](#capítulo-v-product-implementation-validation--deployment)
  ...
  - [5.3 Microservices Implementation](#53-microservices-implementation)
    ...
    - [5.3.2 Sprint 1](#532-sprint-2)
      - [5.3.1.1 Sprint Backlog 2](#5321-sprint-backlog-2)
      - [5.3.1.2 Development Evidence for Sprint Review](#5322-development-evidence-for-sprint-review)
      - [5.3.1.3 Testing Suite Evidence for Sprint Review](#5323-testing-suite-evidence-for-sprint-review)
      - [5.3.1.4 Execution Evidence for Sprint Review](#5314-execution-evidence-for-sprint-review)
      - [5.3.1.5 Microservices Documentation Evidence for Sprint Review](#5325-microservices-documentation-evidence-for-sprint-review)
      - [5.3.1.6 Software Deployment Evidence for Sprint Review](#5326-software-deployment-evidence-for-sprint-review)
      - [5.3.1.7 Team Collaboration Insights during Sprint](#5327-team-collaboration-insights-during-sprint)
    ...
    <tbody>
        <tr>
            ...
            <td>
                ...
                <strong>TB3:</strong> Como equipo, reforzamos y actualizamos constantemente los conceptos técnicos necesarios para el desarrollo de nuestro proyecto, explorando nuevas herramientas, lenguajes y patrones arquitectónicos aplicados a soluciones basadas en microservicios y cloud computing. Este proceso de aprendizaje colaborativo nos permitió integrar buenas prácticas de diseño, testing y despliegue, asegurando una aplicación coherente con los estándares actuales de la industria del software. Asimismo, fortalecimos nuestras competencias profesionales al combinar teoría y práctica en un entorno ágil y orientado a resultados.<br>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                ...
                <strong>TB3:</strong> Como equipo, reconocimos que el aprendizaje permanente es un componente esencial para nuestro crecimiento profesional y para el desarrollo exitoso de proyectos en soluciones de software. A lo largo del curso, enfrentamos desafíos que nos impulsaron a investigar nuevas herramientas, patrones arquitectónicos y metodologías ágiles, fortaleciendo nuestras competencias técnicas y colaborativas. Esta experiencia nos permitió comprender que la actualización constante del conocimiento es indispensable para adaptarnos a las exigencias del sector tecnológico y ofrecer soluciones innovadoras y sostenibles.<br>
            </td>
        </tr>
    </tobdy>
</table>
...
<table style="width: 100%; border-collapse: collapse;">
    ...
    <tr><td>SWR03</td><td>About Us</td><td>Como visitante quiero conocer más acerca del equipo detrás del producto para evaluar qué tan confiable es su origen</td><td><br><br><strong>Acceptance Criteria</strong><br><br>* Debe visualizarse el logo de la organización GreatBuild<br><br>* Debe explicarse la misión de la organización<br><br>* Debe explicarse la visión de la organización<br><br>* Deben mencionarse los valores de la organización<br><br></td><td>EP12</td></tr>
    <tr><td>SWR04</td><td>Hero Section cliente</td><td>Como visitante del segmento cliente quiero visualizar un hero section para conocer rápidamente el valor principal del producto</td><td><br><br><strong>Acceptance Criteria</strong><br><br>* Debe visualizarse una imagen relativa y cercana al segmento de cliente según el user persona Javier Luján mostrando una interacción y experiencia positiva con el producto<br><br>* Debe visualizarse un eslogan que venda la idea principal del producto<br><br></td><td>EP12</td></tr>
...
<img src="./img/chapter3/impactMapping.png" alt="Impact Mapping de ClearCost">
...
<img src="./img/chapter4/ComponentFinance.svg" alt="Diagrama de Finance C3"> 

**Invitation Context** 

<img src="./img/chapter4/ComponentInvitation.svg" alt="Diagrama de Invitation C3"> 

**Organization Context** 

<img src="./img/chapter4/ComponentOrganization.svg" alt="Diagrama de Organization C3"> 
...
<table style="width:100%; border-collapse: collapse;">
    ...
    <tr>
        <td style="padding: 8px; border: 1px solid #ddd; font-weight: bold;">Date</td>
        <td style="padding: 8px; border: 1px solid #ddd;">03-11-2025</td>
    </tr>
    <tr>
        <td style="padding: 8px; border: 1px solid #ddd; font-weight: bold;">Time</td>
        <td style="padding: 8px; border: 1px solid #ddd;">5:00 pm - 10:00 pm</td>
    ...
    <tr>
        <td style="padding: 8px; border: 1px solid #ddd; font-weight: bold;">Prepared By</td>
        <td style="padding: 8px; border: 1px solid #ddd;">León Vivas, Fabrizio</td>
    </tr>
    <tr>
        <td style="padding: 8px; border: 1px solid #ddd; font-weight: bold;">Attendees (to planning meeting)</td>
        <td style="padding: 8px; border: 1px solid #ddd;">León Vivas, Fabrizio Amir
    </tr>
    <tr>
        <td style="padding: 8px; border: 1px solid #ddd; font-weight: bold;">Sprint 1 Review Summary</td>
        <td style="padding: 8px; border: 1px solid #ddd;">Falta de comunicación y coordinación del equipo, se llego al objetivo pero de mala manera.</td>
    </tr>
    <tr>
        <td style="padding: 8px; border: 1px solid #ddd; font-weight: bold;">Sprint 1 Retrospective Summary</td>
        <td style="padding: 8px; border: 1px solid #ddd;">No se delimitó correctamente el alcance del proyecto ocasionando en una deuda técnica. El equipo no trabajó correctamente.</td>
    </tr>
    <tr>
        <th colspan="2" style="padding: 8px; border: 1px solid #ddd; text-align: left;">Sprint Goal & User Stories</th>
    </tr>
    <tr>
        ...
        <td style="padding: 8px; border: 1px solid #ddd;">Desarrollar y documentar los microservicios de users y organizations, y relacionarlos mediante FeignClient. Corregir el alcance del proyecto base.</td>
    </tr>
    <tr>
        <td style="padding: 8px; border: 1px solid #ddd; font-weight: bold;">Sprint 1 Velocity</td>
        <td style="padding: 8px; border: 1px solid #ddd;">8</td>
...
En esta sección se incluyen las evidencias respecto al "Sprint 2" relacionadas con el desarrollo continuo aplicado, mediante el manejo de commits identificados en el repositorio clearcost-platform, encargado del almacenamiento del Backend del proyecto ClearCost. Se presentan las ramas trabajadas, mensaje del commit, cuyos commit messages fueron elaborados siguiendo las buenas practicas de Convential Commits y el modelo de ramificación GitFlow, indicando una auditoria con fechas de cada commit.

| Repositorio          | Rama | Commit ID | Mensaje del Commit                                                         | Fecha       |
|----------------------|-------|------------|---------------------------------------------------------------------------|-------------|
| clearcost-platform   | main  | b82f001    | chore: add organizations microservice and update users microservice.      | 03/11/2025  |
| clearcost-platform   | main  | 6f15adf    | chore: configure pom.xml of msvc-users to use parent pom.xml.             | 02/11/2025  |
| clearcost-platform   | main  | ab1bc3c    | chore: add pom.xml parent.                                                | 02/11/2025  |
| clearcost-platform   | main  | a24c6bf    | Initial commit: Add msvc-users and base project structure                 | 02/11/2025  |

<img style="text-align: center;" src="./img/chapter5/sprint2_development_evidence_1.png"> 

<img style="text-align: center;" src="./img/chapter5/sprint2_development_evidence_2.png"> 

<img style="text-align: center;" src="./img/chapter5/sprint2_development_evidence_3.png"> 

<img style="text-align: center;" src="./img/chapter5/sprint2_development_evidence_4.png"> 

#### 5.3.2.3. Testing Suite Evidence for Sprint Review

**IAM**
<img style="text-align: center;" 
src="./img/chapter5/sprint2_testing_evidence_2.png"> 

**ORGANIZATION**
<img style="text-align: center;" 
src="./img/chapter5/sprint2_testing_evidence_1png.png"> 

#### 5.3.2.4. Execution Evidence for Sprint Review

Para este sprint se desplego la landing page usando Netlify y la visualizacion de microservicios mediante el Swagger.
...
Como evidencia de ejecución del backend tenemos el docs del swagger en donde se muestran los endpoints levantados en puertos diferentes y siguiendo la correcta definición de una arquitectura basada en microservicios.

**USERS**
<img src="./img/chapter5/sprint2_execution_evidence_1.png"> 

**ORGANIZATIONS**
<img src="./img/chapter5/sprint2_execution_evidence_2.png"> 

#### 5.3.2.5. Microservices Documentation Evidence for Sprint Review
Durante este Sprint se continuó se pasó la plataforma de una arquitectura monolítica a una de microservicios. Se configuró el acceso a Swagger UI en entornos locales para validación funcional, y se versionaron los cambios de documentación en el repositorio. A continuación, se presenta la relación de endpoints restantes dentro del alcance del Sprint 2.

**FLUJO DE REGISTRO**
<img src="./img/chapter5/sprint2_microservices_evidence_1.png"> 

**FLUJO DE VALIDACION REGISTRO**
<img src="./img/chapter5/sprint2_microservices_evidence_2.png"> 

**FLUJO DE LOGIN**
<img src="./img/chapter5/sprint2_microservices_evidence_3.png">

**FLUJO DE REGISTRO USANDO EL SERVICIO DE GOOGLE**
<img src="./img/chapter5/sprint2_microservices_evidence_4.png">

**FLUJO DE CREAR UNA ORGANIZACIÓN**
<img src="./img/chapter5/sprint2_microservices_evidence_5.png">
<img src="./img/chapter5/sprint2_microservices_evidence_6.png">

#### 5.3.2.6. Software Deployment Evidence for Sprint Review

Microservicios desplegados:

- msvc-users: http://localhost:8003/swagger-ui/index.html
- msvc-organizations: http://localhost:8002/swagger-ui/index.html

#### 5.3.2.7. Team Collaboration Insights during Sprint
Durante el Sprint 2 yo culmine en su mayoría el backend de la aplicación basada en una arquitectura de microservicios. Se estableció un flujo de trabajo desde la creación de cada microservicio del backend hasta el funcionamiento correcto de cada uno de los entornos de desarrollo.

<img src="./img/chapter5/sprint2_software_evidence_1.png">
<img src="./img/chapter5/sprint2_software_evidence_2.png">
